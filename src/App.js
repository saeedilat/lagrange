...
import Main from './Components/Header/Cantact/Main';
const mainDatas =[
{h:"marketing",p:"300 product"},
{h:"research on the web",p:"100 project"},
{h:"ui/ux design",p:"210 project"},
{h:"web design",p:"42 project"}
]
function App() {
  return (
    <div className="App">
